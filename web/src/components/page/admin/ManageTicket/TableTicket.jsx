...
const TableTicket = React.memo((props) => {
  ...
  return (
    <table class="dataTable-table table" id="pc-dt-simple">
      <thead>
        <tr>
...
const Ticket = (props) => {
  return (
    <tr>
      ...
      <td>Darius Cooley</td>
      <td>
        <div className="status-badde3 badge rounded bg-info p-2 px-3">
          Medium
        </div>
      </td>
      <td>Jul 1, 2022</td>
      ...
      <td>
        ...
        >
          Ad ab ad voluptas ma
        </p>
      </td>
      <td class="Action">
        <span>
          <div className="action-btn ms-2 bg-primary">
            <a
              href="https://demo.rajodiya.com/hrmgo-saas/ticket/45/reply"
              className="align-items-center btn btn-sm  mx-3"
          ...
          <div className="action-btn bg-danger ms-2">
            <form
              method="POST"
              action="https://demo.rajodiya.com/hrmgo-saas/ticket/45"
            ...
            >
              ...
              <a
                href="#"
                class="align-items-center bs-pass-para btn  btn-sm mx-3"
                data-bs-toggle="tooltip"
                title=""
